 ...
 */
class SLayoutNode : public Object {
 public:
  ...
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("s_tir.SLayout", SLayoutNode, Object);
};
 ...
 * \sa SLayoutNode
 */
class SLayout : public ObjectRef {
 public:
  ...
  TVM_FFI_DEFINE_OBJECT_REF_METHODS_NULLABLE(SLayout, ObjectRef, SLayoutNode);
};

// Internal node container SBijectiveLayout
class SBijectiveLayoutNode : public Object {
 public:
  ...
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("s_tir.SBijectiveLayout", SBijectiveLayoutNode, Object);
};
 ...
 */
class SBijectiveLayout : public ObjectRef {
 public:
  /*!
  ...
  TVM_FFI_DEFINE_OBJECT_REF_METHODS_NULLABLE(SBijectiveLayout, ObjectRef, SBijectiveLayoutNode);
};
