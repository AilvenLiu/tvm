...
"""Implementation of binary operator dispatchs for CUDA targets.
...
def _get_thread_cnt(sctx: DispatchContext) -> int | None:
...
#
from tvm.tirx.operator.scope_op_dispatch import register_dispatch  # noqa: E402
