...
from tvm.tirx.op_dispatch import DispatchContext, fail, predicate, register_dispatch
...
for op_name, op_type in [
    ...
    def _default_dispatch(op: OpCall, sctx: DispatchContext, _op_type=op_type) -> PrimFunc:
