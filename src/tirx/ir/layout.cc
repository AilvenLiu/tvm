...
TVM_REGISTER_GLOBAL("tirx.TLayoutApply")
...
TVM_REGISTER_GLOBAL("tirx.DataIterAttr").set_body_typed([](PrimExpr extent, PrimExpr stride) {
...
TVM_REGISTER_GLOBAL("tirx.TileLayoutTile")
...
TVM_REGISTER_GLOBAL("tirx.TrainiumLayout")
...
TVM_REGISTER_GLOBAL("tirx.TrainiumLayoutGetPartitionSize").set_body_typed([](TrainiumLayout layout) {
...
TVM_REGISTER_GLOBAL("tirx.NormalizeTrainiumLayout").set_body_typed(NormalizeTrainiumLayout);
...
TVM_REGISTER_GLOBAL("tirx.NormalizeTrainiumLayoutWithShape")
...
TVM_REGISTER_GLOBAL("tirx.NormalizeTileLayoutWithShape")
