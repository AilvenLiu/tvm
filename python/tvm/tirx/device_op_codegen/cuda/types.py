...
from_string_func = tvm_ffi.get_global_func("tirx.device_op_codegen.cuda.PTXDTypeFromString")
to_string_func = tvm_ffi.get_global_func("tirx.device_op_codegen.cuda.PTXDTypeToString")
