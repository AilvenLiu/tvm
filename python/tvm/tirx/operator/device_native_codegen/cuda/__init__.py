...
# Import header generator and tags (registers tirx.device_native_codegen.cuda.header_generator)
...
# Import registry (registers tirx.device_native_codegen.cuda.get_codegen)
