...
TVM_FFI_STATIC_INIT_BLOCK() {
  ...
  refl::TypeAttrDef<VarNode>().def(
      refl::type_attr::kRepr,
      [](Var var, ffi::Function) -> ffi::String { return std::string(var->name_hint); });
  refl::TypeAttrDef<SizeVarNode>().def(
      refl::type_attr::kRepr,
      [](SizeVar var, ffi::Function) -> ffi::String { return std::string(var->name_hint); });
}
